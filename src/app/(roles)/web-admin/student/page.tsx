...
interface Student {
    ...
    phone: string;
    email: string;
    totalPursesClass: number;
    totalSpend: string;
    date: string;
    status: "Active" | "Deactivate";
}

const mockStudents: Student[] = Array(7).fill(null).map((_, i) => ({
    id: i + 1,
    name: "Anna Jensen",
    phone: "+88 01745826592",
    email: "user@gmail.com",
    totalPursesClass: 5015,
    totalSpend: "$5,765",
    date: "1 Jan, 2026",
                    ...
                    <table className="w-full text-left border-collapse min-w-[1000px]">
                        <thead>
                            <tr className="border-b border-gray-100 bg-gray-50/50">
                                {["Name", "Phone", "Email", "Total Purses Class", "Total Spend", "Date", "Status", "Actions"].map((header) => (
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {mockStudents.map((student) => (
                                <tr key={student.id} className="hover:bg-gray-50/50 transition-colors group">
                                    ...
                                    <td className="px-6 py-4 text-sm text-gray-600 text-center font-sans">{student.totalPursesClass}</td>
                                    <td className="px-6 py-4 text-sm text-gray-600 font-sans text-center">{student.totalSpend}</td>
                                    <td className="px-6 py-4 text-sm text-gray-600 font-sans text-center">{student.date}</td>
