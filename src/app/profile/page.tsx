...
export default function ProfilePage() {
    return (
        <main className="min-h-screen bg-gray-50/30">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16 py-12 space-y-10">
                ...
                <div className="space-y-6">
                    <div className="flex items-center gap-8 border-b border-gray-100">
                        <button className="pb-4 border-b-2 border-[#0A47C2] text-[#0A47C2] font-bold text-sm font-sans tracking-tight">Purchase history</button>
                    </div>
                        ...
                        {purchaseHistory.map((item) => (
                            <div key={item.id} className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-shadow group flex flex-col">
                                ...
                                <div className="p-4 space-y-3">
                                    ...
                                    <div className="pt-2">
                                        <button className="w-full py-2.5 bg-[#0A47C2] text-white font-bold rounded-xl text-xs font-sans hover:bg-[#083a9e] transition-colors flex items-center justify-center gap-2">
